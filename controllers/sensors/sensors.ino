...
//analog pins
const int moisture_pin = A0; // connected to soil moisture sensor 
const int gas_1_pin = A1;    // connected to gas sensor
const int gas_2_pin = A2;
const int gas_3_pin = A3;
const int voltage_sensor_pin = A4;  // connected to voltage sensor (DFR0051)
